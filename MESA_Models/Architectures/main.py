...
if __name__ == '__main__':
    ...
    if(runBatch):
        ...
        variable_params = {"probability": range(1, 10, 1)}
        batch_run = BatchRunner(
            ...
            iterations=5,
            max_steps=50,
            model_reporters= {"Utilisation": utilisation.machine_utilisation, "Complete Orders": orders.ordersComplete, 'Average_Order_Wait_Time': orders.averageOrderWaitTime},
        ...
        os.makedirs('/Users/heisenberg/IP/MESA_Models/Architectures/results/test_{0}'.format(number))

        model_data.to_pickle('/Users/heisenberg/IP/MESA_Models/Architectures/results/test_{0}/model_data.pkl'.format(number))
        agent_data.to_pickle('/Users/heisenberg/IP/MESA_Models/Architectures/results/test_{0}/agent_data.pkl'.format(number))
